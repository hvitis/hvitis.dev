        ...
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-800">
          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-gray-200 pb-8 dark:divide-gray-800 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0">
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-800 xl:col-span-3 xl:row-span-2 xl:pb-0">
              ...
              <div className="pb-6 pt-6 text-sm text-gray-400 dark:text-gray-500">
                <Link
            ...
            <footer>
              <div className="divide-gray-200 text-sm leading-5 dark:divide-gray-800 xl:col-start-1 xl:row-start-2 xl:divide-y">
                {tags && (
                  ...
                  <div className="flex justify-between py-4 xl:block xl:space-y-8 xl:py-8">
                    {prev && prev.path && (
                      <div>
                        ...
                        <div className="font-serif italic text-gray-700 transition-colors hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100">
              ...
              <div className="pt-4 xl:pt-8">
                <Link
                  href={`/${basePath}`}
                  className="text-xs uppercase tracking-[0.2em] text-gray-400 transition-colors hover:text-gray-900 dark:text-gray-500 dark:hover:text-gray-100"
