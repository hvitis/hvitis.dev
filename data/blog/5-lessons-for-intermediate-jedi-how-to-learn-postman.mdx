...
![cURL](./cURL-copy-request.PNG 'cURL')

And then copy here:

![import-cURL](./POSTMAN-post-cURL-import.PNG 'Import cURL')
...
![windows-proxy](./proxy-connect-windows-settings.PNG 'Setting up proxy on Windows 10')
...
![postman-proxy](./proxy-postman-proxy-settings.PNG 'Setting up proxy on POSTMAN')

Now you just have to switch on Capturing requests option:

![postman-proxy-options](./proxy-postman-options.PNG 'Setting up proxy on POSTMAN')
...
![postman-proxy-gif](./proxy-postman-intercepting-requests.gif 'Setting up proxy on POSTMAN gif')

HTTP or HTTPS is important, because you might see this instead:

![connection-not-private](./connection-not-private.PNG 'connection-not-private')
...
![postman-collection-response-time-measuring](./postman-collection-response-time-measuring.PNG 'postman-collection-response-time-measuring')
...
![postman-collection-response-time-measuring-run](./postman-collection-response-time-measuring-run.PNG 'postman-collection-response-time-measuring-run')
...
![postman-collection-authentication](./postman-collection-authentication.PNG 'postman-collection-authentication')
...
1. First click on the bottom left:
   ![postman-cookies-whitelist](./postman-cookies-whitelist.PNG 'postman-cookies-whitelist')
2. Then add the domain that you need to clean the cookies for.
   ![postman-cookies-whitelist-add](./postman-cookies-whitelist-add.PNG 'postman-cookies-whitelist-add')
...
![postman-docs-example-response](./postman-docs-example-response.png 'postman-docs-example-response')

_HINT:_ Try adding description to the requests. It's a bit hidden so you might have missed it:

![postman-request-description](./postman-request-description.png 'postman-request-description')
...
![postman-shared-collections](./postman-shared-collections.png 'postman-shared-collections')

![postman-shared-collections-space](./postman-shared-collections-space.png 'postman-shared-collections-space')
