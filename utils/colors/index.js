...
const loadedColors = {
  pl: [
    ...
    },
    {
      id: 2,
      name: 'Andy Warhol',
      description: 'Wariacje Mona Lisy w różnych kolorach',
    ...
    },
    {
      id: 3,
      name: 'The Beatels',
      description: 'Lennon i inni, portrety 4x4',
    ...
    },
    {
      id: 4,
      name: 'Iron Man',
      description: 'Portrety War Machine Mark II i Iron Mana',
    ...
    },
    {
      id: 5,
      name: 'Harry Potter',
      description: 'Herby każdego z domów',
    ...
    },
    {
      id: 6,
      name: 'Star Wars',
      description: 'Darth Maul, Dark Vader i Dark Trooper',
    ...
    },
    {
      id: 7,
      name: 'Mickey Mouse',
      description: 'Mickey i Minnie mouse',
    ...
    },
    {
      id: 8,
      name: 'World Map',
      description: 'Mapa wszystkich kontynentów',
    ...
    },
    {
      id: 9,
      name: 'Portrait',
      description: 'Mozaika własnej twarzy',
    ...
    },
    {
      id: 13,
      name: 'Elvis Presley',
      description: 'Trzy ujęcia twarzy Elwisa',
      colors: COLORS_ELVIS,
      nr: '31204',
    ...
    },
    {
      id: 14,
      name: 'Art Project',
      description: '36 małych portretów',
  ...
  en: [
    ...
    },
    {
      id: 13,
      name: 'Elvis Presley',
      description: 'Elvis from 3 different angles',
      colors: COLORS_ELVIS,
      nr: '31204',
      image: '/webp/sets/80x80-elvis.webp',
      pcs: 3445,
    },
    {
      id: 14,
      name: 'Art Project',
      description: '36 small portraits',
      colors: COLORS_ART_PROJECT,
      nr: '21226',
      image: '/webp/sets/80x80-art-project.webp',
      pcs: 4138,
