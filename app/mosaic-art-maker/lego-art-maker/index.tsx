        ...
        <div>
          ...
          <div>
            ...
            <div>
              <div>
                {' '}
                <div>DISCLAIMER :</div> LEGO and the LEGO logo are trademarks and/or copyrights of
                the LEGO Group. This project is not at all affiliated with The LEGO Group, and was
                simply a project of mine using the LEGO name as a proprietary eponym.{' '}
              </div>
            </div>
          </div>
        </div>
