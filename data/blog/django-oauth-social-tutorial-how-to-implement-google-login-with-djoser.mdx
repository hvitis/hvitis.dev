...
![OAuth2Djoser](./oauth2-google-django-tutorial.png 'Google OAuth2 Django Djoser')

Here you need to put the redirection allowed URL

![OAuth2Djoser](./oauth2-google-django-tutorial-credentials.png 'Google OAuth2 Django Djoser')
...
![OAuth2DjoserGoogleTokenRegisterDjango](./oauth-google-postman-authorization-uri.png 'Google OAuth2 Django Djoser')
...
![OAuth2DjoserGoogleTokenRegisterDjango](./oauth-google-postman-authorization-account.png 'Google OAuth2 Django Djoser')
...
![OAuth2DjoserGoogleTokenRegisterDjango](./oauth-google-login-screen.png 'Google OAuth2 Django Djoser')
...
![OAuth2DjoserGoogleTokenRegisterDjango](./oauth-google-response-code-state.png 'Google OAuth2 Django Djoser')

Copy the code to 3rd POSTMAN endpoint (POST) and obtain TOKEN! 🎉🎊

![OAuth2DjoserGoogleTokenRegisterDjango](./oauth-google-response-code-state-postman-how-to-obtain-token.png 'Google OAuth2 Django Djoser')
