...
Then I decided to work on [mosaic generator](/mosaic-art-maker) to have at least something better than my lego portrait and published first version of the [mosaic maker](/mosaic-art-maker). People started using it and soon after they started telling me about their ideas and suggestions regarding the application.

LEGO maker got great reviewes which pushed me to code (and learn) more and more. The market was changing in paralell. LEGO Dots came to market, more LEGO sets. I was adding new color sets to the website and playing around with other ideas and functionalities. Then, due to limitations of my knowledge and technology I paused the development.
