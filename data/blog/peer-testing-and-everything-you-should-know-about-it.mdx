...
<mark>Peer</mark> can have three meanings, all of them can have it's place in the whole explanation:
...
<mark>Peer-testing is checking the functionality of other developer's code.</mark>
...
- Another developer starts testing and if the issue is:
  <mark>Rejected</mark> then he fowards it back and explains the error.
  <mark>Approved</mark> then he passed the issue to a tester.
